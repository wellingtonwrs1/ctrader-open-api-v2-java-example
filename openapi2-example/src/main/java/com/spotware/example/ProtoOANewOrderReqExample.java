...
public class ProtoOANewOrderReqExample {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            sendProtoOANewOrderReq(nettyClient, config.getCtid());
        } finally {
        	nettyClient.closeConnection();
        }
    }

    private static void sendProtoOANewOrderReq(NettyClient nettyClient, long ctidTraderAccountId) throws InterruptedException {
    	ProtoOANewOrderReq protoOANewOrderReq = ProtoOANewOrderReq
                .newBuilder()
                ...
                .build();
        ProtoMessageReceiver receiver = nettyClient.writeAndFlush(protoOANewOrderReq);
